...
public class VideoSvc {
	...
	public void getData(@PathVariable("id") long id,HttpServletResponse response) throws IOException {
		...
		if(videoData == null) videoData = VideoFileManager.get();
		try{
	...
	public @ResponseBody Video addVideoMetadata(@RequestBody Video v, HttpServletRequest request) throws IOException {
